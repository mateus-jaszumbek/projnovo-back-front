        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InscricaoEstadual = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    InscricaoMunicipal = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    RegimeTributario = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Nome = table.Column<string>(type: "TEXT", maxLength: 150, nullable: false),
                    TipoPessoa = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Ambiente = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    RegimeTributario = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ...
                    ProximoNumeroNfce = table.Column<long>(type: "INTEGER", nullable: false),
                    ProximoNumeroNfe = table.Column<long>(type: "INTEGER", nullable: false),
                    ProximoNumeroNfse = table.Column<long>(type: "INTEGER", nullable: false),
                    ProvedorFiscal = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    MunicipioCodigo = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    CnaePrincipal = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    ItemListaServico = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    NaturezaOperacaoPadrao = table.Column<string>(type: "TEXT", nullable: true),
                    IssRetidoPadrao = table.Column<bool>(type: "INTEGER", nullable: false),
                    AliquotaIssPadrao = table.Column<decimal>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    TipoDocumentoFiscal = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Provedor = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    UrlBase = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ...
                    UsuarioApi = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoPessoa = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    CpfCnpj = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    Contato = table.Column<string>(type: "TEXT", maxLength: 150, nullable: true),
                    Telefone = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    TipoDocumentoFiscal = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    UfOrigem = table.Column<string>(type: "TEXT", maxLength: 2, nullable: true),
                    UfDestino = table.Column<string>(type: "TEXT", maxLength: 2, nullable: true),
                    RegimeTributario = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    Ncm = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    Cfop = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    CstCsosn = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    Cest = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    OrigemMercadoria = table.Column<string>(type: "TEXT", maxLength: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoInterno = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AbertoPor = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SerieRps = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    NumeroRps = table.Column<long>(type: "INTEGER", nullable: true),
                    ...
                    ClienteCpfCnpj = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    ClienteEmail = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ClienteTelefone = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    ClienteCep = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    ClienteLogradouro = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ClienteNumero = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    ClienteComplemento = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ClienteBairro = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ClienteCidade = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ClienteUf = table.Column<string>(type: "TEXT", maxLength: 2, nullable: true),
                    ClienteMunicipioCodigo = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    DataEmissao = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DataCompetencia = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ...
                    ChaveAcesso = table.Column<string>(type: "TEXT", maxLength: 80, nullable: true),
                    Protocolo = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    CodigoVerificacao = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    LinkConsulta = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    NumeroExterno = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ...
                    XmlUrl = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    PdfUrl = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    CodigoRejeicao = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    MensagemRejeicao = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    PayloadEnvio = table.Column<string>(type: "text", nullable: true),
                    PayloadRetorno = table.Column<string>(type: "text", nullable: true),
                    MotivoCancelamento = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Imei = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    SerialNumber = table.Column<string>(type: "TEXT", maxLength: 60, nullable: true),
                    SenhaAparelho = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmpresaId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ClienteId = table.Column<Guid>(type: "TEXT", nullable: true),
                    OrigemTipo = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    ...
                    Status = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    FormaPagamento = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    Observacoes = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    NumeroVenda = table.Column<long>(type: "INTEGER", nullable: false),
                    ClienteId = table.Column<Guid>(type: "TEXT", nullable: true),
                    Status = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    FormaPagamento = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fornecedor = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModeloCompativel = table.Column<string>(type: "TEXT", maxLength: 150, nullable: true),
                    Ncm = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    Cest = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    CfopPadraoNfe = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    CfopPadraoNfce = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    CstCsosn = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    OrigemMercadoria = table.Column<string>(type: "TEXT", maxLength: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    KanbanFluxoId = table.Column<Guid>(type: "TEXT", nullable: false),
                    NomeInterno = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    NomePublico = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ...
                    VisivelCliente = table.Column<bool>(type: "INTEGER", nullable: false),
                    GeraEventoCliente = table.Column<bool>(type: "INTEGER", nullable: false),
                    EtapaFinal = table.Column<bool>(type: "INTEGER", nullable: false),
                    PermiteEnvioWhatsApp = table.Column<bool>(type: "INTEGER", nullable: false),
                    DescricaoPublica = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    EmpresaId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ModuloPersonalizadoId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CampoChave = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    Aba = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false, defaultValue: "Principal"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_campos_modulo_layout_modulos_personalizados_ModuloPersonalizadoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Posicao = table.Column<int>(type: "INTEGER", nullable: false),
                    Ordem = table.Column<int>(type: "INTEGER", nullable: false),
                    Placeholder = table.Column<string>(type: "TEXT", maxLength: 150, nullable: true),
                    ValorPadrao = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                    OpcoesJson = table.Column<string>(type: "text", nullable: true),
                    ExportarExcel = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    ExportarExcelResumo = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    ExportarPdf = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    Ativo = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    EmpresaId = table.Column<Guid>(type: "TEXT", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_campos_personalizados_modulos_personalizados_ModuloPersonalizadoId",
                        column: x => x.ModuloPersonalizadoId,
                        principalTable: "modulos_personalizados",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_registros_personalizados_modulos_personalizados_ModuloPersonalizadoId",
                        column: x => x.ModuloPersonalizadoId,
                        principalTable: "modulos_personalizados",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    EmpresaId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CaixaDiarioId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Tipo = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    OrigemTipo = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    OrigemId = table.Column<Guid>(type: "TEXT", nullable: true),
                    FormaPagamento = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    DocumentoFiscalId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TipoEvento = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
                    Status = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Protocolo = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    DocumentoFiscalId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TipoOperacao = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
                    Status = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_integracoes_fiscais_jobs_documentos_fiscais_DocumentoFiscalId",
                        column: x => x.DocumentoFiscalId,
                        principalTable: "documentos_fiscais",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    NumeroOs = table.Column<long>(type: "INTEGER", nullable: false),
                    DocumentoFiscalId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ClienteId = table.Column<Guid>(type: "TEXT", nullable: false),
                    AparelhoId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ...
                    ValorMaoObra = table.Column<decimal>(type: "TEXT", precision: 14, scale: 2, nullable: false),
                    ValorPecas = table.Column<decimal>(type: "TEXT", precision: 14, scale: 2, nullable: false),
                    Desconto = table.Column<decimal>(type: "TEXT", precision: 14, scale: 2, nullable: false),
                    ...
                    DataPrevisao = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ...
                    KanbanColunaAtualId = table.Column<Guid>(type: "TEXT", nullable: true),
                    TrackingToken = table.Column<string>(type: "TEXT", nullable: false),
                    TrackingPublicoAtivo = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    EmpresaId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServicoCatalogoId = table.Column<Guid>(type: "TEXT", nullable: true),
                    PecaId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ...
                    IssRetido = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_documentos_fiscais_itens_documentos_fiscais_DocumentoFiscalId",
                        column: x => x.DocumentoFiscalId,
                        principalTable: "documentos_fiscais",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoMovimento = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
                    Quantidade = table.Column<decimal>(type: "TEXT", precision: 14, scale: 3, nullable: false),
                    CustoUnitario = table.Column<decimal>(type: "TEXT", precision: 14, scale: 2, nullable: false),
                    OrigemTipo = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    OrigemId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantidadeSolicitada = table.Column<decimal>(type: "decimal(18,3)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    KanbanColunaId = table.Column<Guid>(type: "TEXT", nullable: false),
                    OrdemServicoId = table.Column<Guid>(type: "TEXT", nullable: false),
                    PublicTrackingToken = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    PublicTrackingAtivo = table.Column<bool>(type: "INTEGER", nullable: false),
                    Ordem = table.Column<int>(type: "INTEGER", nullable: false),
                    Ativo = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    OrdemServicoId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ColunaOrigemId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ColunaDestinoId = table.Column<Guid>(type: "TEXT", nullable: false),
                    UsuarioId = table.Column<Guid>(type: "TEXT", nullable: false),
                    NomeColunaOrigem = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    NomeColunaDestino = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    HistoricoPublico = table.Column<bool>(type: "INTEGER", nullable: false),
                    TituloPublico = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    DescricaoPublica = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    PublicTrackingToken = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantidade = table.Column<decimal>(type: "TEXT", precision: 14, scale: 3, nullable: false),
                    CustoUnitario = table.Column<decimal>(type: "TEXT", precision: 14, scale: 2, nullable: false),
                    ValorUnitario = table.Column<decimal>(type: "TEXT", precision: 14, scale: 2, nullable: false),
                    Desconto = table.Column<decimal>(type: "TEXT", precision: 14, scale: 2, nullable: false),
                    ValorTotal = table.Column<decimal>(type: "TEXT", precision: 14, scale: 2, nullable: false),
                    GarantiaDias = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_campos_modulo_layout_EmpresaId_ModuloPersonalizadoId_CampoChave",
                table: "campos_modulo_layout",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_campos_personalizados_ModuloPersonalizadoId_Aba_Linha_Posicao",
                table: "campos_personalizados",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_credenciais_fiscais_empresas_EmpresaId_TipoDocumentoFiscal_Provedor",
                table: "credenciais_fiscais_empresas",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_documentos_fiscais_EmpresaId_TipoDocumento_OrigemTipo_OrigemId",
                table: "documentos_fiscais",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrdemServicoKanbanHistorico_EmpresaId_OrdemServicoId_DataMovimentacao",
                table: "OrdemServicoKanbanHistorico",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_registros_personalizados_EmpresaId_ModuloPersonalizadoId_OrigemId",
                table: "registros_personalizados",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_regras_fiscais_produtos_EmpresaId_TipoDocumentoFiscal_UfOrigem_UfDestino_RegimeTributario_Ncm",
                table: "regras_fiscais_produtos",
